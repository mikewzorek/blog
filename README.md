...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/mikewzorek/bloge&stack=cms)
...
```
git clone https://github.com/mike/blog.git my-blog-name
```
